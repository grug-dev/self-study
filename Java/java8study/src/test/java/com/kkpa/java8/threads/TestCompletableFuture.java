...
public class TestCompletableFuture {
	...
	public void testCreateACompletableFuture() {
		...
		CompletableFuture compTableFutureTest = competableFutureFactory.createACompletableFuture(message); 
	...
	public void testThenApply() {
		...
		log("[testThenApply]");
		CompletableFuture cf = competableFutureFactory.createACompletableFuture(msgToTest);
	...
	public void testApplyingFunctionResultAnotherFunction() {	    
	    ...
	    log(method);
	    CompletableFuture<String> upperCaseFunction = competableFutureFactory.transformToUpperCaseAsync(MESSAGE, ONE_SECOND );
		
	    CompletableFuture<String> lowerCaseFunction = competableFutureFactory.transformToLowerCaseAsync(MESSAGE, ONE_SECOND);
		
	    CompletableFuture<String> resultFunction = upperCaseFunction.applyToEither(lowerCaseFunction, (s) -> s + ANOTHER_MESSAGE );
